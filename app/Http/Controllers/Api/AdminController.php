...
class AdminController extends Controller{
    ...
    public function getBookings(Request $request){
        ...
        if($user->role == "admin"){
            ...
            ->select('sum(transactions.amount) as total', 'bookings.*', "services.en_name", "services.ar_name", "services.price", "users.full_name", "users.avatar", "users.phone",
    ...
    public function getOrders(Request $request){
        ...
        if($user->role == "admin"){
            ...
            ->select('sum(transactions.amount) as total', 'orderings.*', "transactions.payment_id", "transactions.amount", "transactions.payment_status", "users.full_name", "users.email", "users.phone")
