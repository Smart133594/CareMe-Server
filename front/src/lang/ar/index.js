...
export default {
    ...
    bookingSuccess: "Booking Successfuly. You can check on your dashboard",
    bookingFailed: "Booking Failed, please check your network or coupon code.",
