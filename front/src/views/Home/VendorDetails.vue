    ...
    <div class="container">
        ...
        <v-row class="align-items-center">
            <v-col xl="6" lg="6" md="6" sm="12" cols="12">
                <gmap-map :center="center" :zoom="9" ref="mapRef" style="width: 100%; height: 300px" :options="mapOptions">
                    <gmap-marker :position="{lat: parseFloat(marker.position.lat), lng: parseFloat(marker.position.lng)}" :label="getAddress">
                    </gmap-marker>
                </gmap-map>
            </v-col>
            <v-col xl="6" lg="6" md="6" sm="12" cols="12" class="p-10">
                ...
                <div class="d-custom-flex align-items-center justify-content-center mt-5">
                    ...
                    <h5 class="text-purple pl-5">
                        {{vendor[selectedLocale.locale == "en" ? "en_address" : "ar_address"]}}
                    </h5>
                </div>
                <div class="d-custom-flex align-items-center justify-content-center mt-5">
                    <span class="icon-style" style="font-size: 25px">
                ...
                <div class="d-custom-flex align-items-center justify-content-center mt-5">
                    <v-rating readonly v-model="vendor.rating" background-color="orange" color="orange"></v-rating>
                </div>
                <!-- <div class="d-custom-flex align-items-center justify-content-center mt-5">
        ...
        <v-row class="mt-5">
            <v-row>
                        ...
                        <v-list>
                            <app-card>
                                ...
                                <div class="content" style="max-height:500px">
                                    <v-checkbox :label="item[selectedLocale.locale == 'en' ? 'en_name' : 'ar_name']" v-model="selectedDepartments" :value="item.id" hide-details v-for="(item, index) in vendor.departments" :key="`${index}_department`">
                                    </v-checkbox>
                                </div>
                            </app-card>
                        </v-list>
                ...
                <v-col xl="9" lg="9" md="9" sm="12" cols="12">
                    <hot-deals :small="true" :servicies="filteredServicies" :products="filteredProducts"></hot-deals>
                </v-col>
            </v-row>
        </v-row>
    </div>
