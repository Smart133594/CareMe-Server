      ...
      <div class="card-item__wrapper">
        ...
        <div class="card-item__content">
          <label :for="fields.cardName" class="card-item__info" :ref="fields.cardName">
            <div class="card-item__holder">{{ $t('message.cardHolder') }}</div>
            <transition name="slide-fade-up">
              ...
              <div class="card-item__name" v-else key="2">{{ $t('message.fullName') }}</div>
            </transition>
          </label>
          <div class="card-item__date" ref="cardDate">
            <label :for="fields.cardMonth" class="card-item__dateTitle">{{ $t('message.expires') }}</label>
            <label :for="fields.cardMonth" class="card-item__dateItem">
              <transition name="slide-fade-up">
                ...
                <span v-else key="2">{{ $t('message.MM') }}</span>
              </transition>
            </label>
            /
            <label for="cardYear" class="card-item__dateItem">
              <transition name="slide-fade-up">
                ...
                <span v-else key="2">{{ $t('message.YY') }}</span>
              </transition>
            </label>
          </div>
        </div>
