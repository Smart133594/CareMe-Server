<template>
  <div class="card-form">
        ...
        <div class="card-form__col">
          <div class="card-form__group">
            ...
            <select
              ...
              data-card-field
            >
              <option value disabled selected>{{ $t("message.month") }}</option>
              <option
            ...
            <select
              ...
              data-card-field
            >
              <option value disabled selected>{{ $t("message.year") }}</option>
              <option
    ...
    <v-btn v-if="submitButton" :loading="loading" class="card-form__button" v-on:click="invaildCard">
      {{ $t("message.submit") }}
    </v-btn>
  </div>
</template>
    ...
    invaildCard() {
      ...
      if (sum % 10 !== 0) {
        Vue.notify({
          group: "center",
          type: "error",
          text: this.$t("message.invalidCardNumber"),
        });
      ...
      } else if (this.formData.cardMonth == "") {
        Vue.notify({
          group: "center",
          type: "error",
          text: this.$t("message.invalidCardMonth"),
        });
      } else if (this.formData.cardYear == "") {
        Vue.notify({
          group: "center",
          type: "error",
          text: this.$t("message.invalidCardYear"),
        });
      } else if (this.formData.cardCvv == "") {
        Vue.notify({
          group: "center",
          type: "error",
          text: this.$t("message.invalidCardCVV"),
        });
      } else {
        this.$emit("submit");
      }
