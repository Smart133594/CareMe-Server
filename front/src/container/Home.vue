  ...
  <div class="main-container">
            ...
            <app-card class="auth-card">
              <v-form v-model="valid" class="mb-5">
                <div class="user-image text-center mb-4">
                  <img
                    @click="chooseFiles(i)"
                    :src="avatar ? avatar : '/static/avatars/male.png'"
                ...
                />
                  <VuePhoneNumberInput
                    ...
                    required
                    dark-color="#2e3343"
                    default-country-code="OM"
                    :preferred-countries="['OM', 'US', 'DE']"
                  />
      ...
      <v-card>
        ...
        <v-card-text>
          <v-form>
            <v-row>
              <v-text-field
                :label="$t('message.pleaseEnterYourPasswordToReset')"
                v-model="password"
                prepend-icon="ti-lock"
                :rules="passwordRules"
                type="password"
    ...
    <v-dialog v-model="verify" persistent max-width="500px">
      <v-card class="elevation-5" dark>
        <v-img
          class="align-start justify-center white--text"
          src="/static/img/phone-verify.jpg"
          alt="Card Image"
          height="200"
        >
        </v-img>
          ...
          <v-form class="mb-5">
            <v-row class="px-3 input-row">
              <v-text-field
                v-model="verify_code"
                :rules="verifyRules"
                prepend-icon="ti-check"
                :label="$t('message.verifyCode')"
                required
              ></v-text-field>
            </v-row>
          </v-form>
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      avatar: null,
      phone: appConfig.testMode ? "92123456" : "",
      phoeObject: null,
      first_name: appConfig.testMode ? "bognar" : "",
      firstNameRules: [(v) => !!v || this.$t("message.fieldRequired")],
      last_name: appConfig.testMode ? "vojislav" : "",
      lastNameRules: [(v) => !!v || this.$t("message.fieldRequired")],
      email: appConfig.testMode ? "bognarvojislav791@gmail.com" : "",
      emailRules: [
      ...
      password: appConfig.testMode ? "123456" : "",
